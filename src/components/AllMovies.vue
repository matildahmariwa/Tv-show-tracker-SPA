        ...
        <div class="grid-x intro">
            <div class="cell large-6 medium-8 small-12 one" >
                ...
                <span class="movie-name" >SEE</span> <br>
                    ...
                    A virus has decimated humankind. Those who survived <br> emerged blind. Centuries later when twins are born with
            ...
            <div class="cell large-6 medium-8 small-12 two">
                <img style="margin-left: 5px" src="https://cdn2.glamour.es/uploads/images/thumbs/es/glam/4/s/2019/37/2_minutos_jason_momoa_increible_trailer_see_4344_620x620.jpg">
